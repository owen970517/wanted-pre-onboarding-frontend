...
const ModifyToDo = () => {
    const {modifyToDo, modifyId, modifyCompleted, setModifyCompleted, setModifyToDo, setIsModify} =
        useToDoContext();
    ...
    return (
        <>
            <StyledLabel>
                <StyledCheckBox
                    type='checkbox'
                    onChange={e => setModifyCompleted(e.target.checked)}
                    checked={modifyCompleted}
                />
                <ModifyInput
                    type='text'
